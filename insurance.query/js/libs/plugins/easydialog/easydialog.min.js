 ...
 * Date : 2012-04-22
 */
function msg(text, time, overlay, callback) { easyDialog.open({ container: { content: text }, autoClose: (time ? time : 2500), overlay: (overlay ? overlay : false), callback: (callback ? callback(): undefined) }); }
